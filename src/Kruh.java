...
public class Kruh {
    ...
    /**
     * (Kruh) Vráť x-ovú súradnicu.
     * @return x-ová súradnica kruhu, atribút lavyHornyX
     */
    public double getX() {
    ...
    /**
     * (Kruh) Vráť y-ovú súradnicu.
     * @return y-ová súradnica kruhu, atribút lavyHornyY
     */
    public double getY() {
    ...
    /**
     * (Kruh) Posuň sa o zadané hodnoty.
     * @param x hodnota, o ktorú sa má posunúť na x-ovej osi
     * @param y hodnota, o ktorú sa má posunúť na y-ovej osi
     */
