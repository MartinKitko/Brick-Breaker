...
public class Obdlznik {
    ...
    /**
     * (Obdĺžnik) Posuň sa vodorovne na súradnicu danú parametrom.
     * @param  x   súradnica na ktorú sa má plošina presunúť
     */
    public void posunVodorovneNa(int x) {
        this.skry();
        this.lavyHornyX = x;
        this.zobraz();
    }
